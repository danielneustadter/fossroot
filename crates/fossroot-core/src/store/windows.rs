...
use windows::Win32::Security::Cryptography::{
    ...
    CertEnumCertificatesInStore, CertFindCertificateInStore, CertOpenStore, CERT_CONTEXT,
    CERT_FIND_SHA1_HASH, CERT_OPEN_STORE_FLAGS, CERT_QUERY_ENCODING_TYPE,
    CERT_STORE_ADD_REPLACE_EXISTING, CERT_STORE_OPEN_EXISTING_FLAG,
    CERT_STORE_PROV_SYSTEM_REGISTRY_W, CERT_STORE_READONLY_FLAG, CERT_SYSTEM_STORE_CURRENT_USER,
    CERT_SYSTEM_STORE_LOCAL_MACHINE, CRYPT_INTEGER_BLOB, HCERTSTORE, HCRYPTPROV_LEGACY,
    X509_ASN_ENCODING,
};
